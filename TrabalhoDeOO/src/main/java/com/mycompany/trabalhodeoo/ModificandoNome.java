 ...
 * @author pedro
 */
public class ModificandoNome extends javax.swing.JFrame {

    /**
     * Creates new form ModificandoNome
     */
    public ModificandoNome() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Modificando Nome do Produto");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificandoNome.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificandoNome().setVisible(true);
            }
        });
    }
