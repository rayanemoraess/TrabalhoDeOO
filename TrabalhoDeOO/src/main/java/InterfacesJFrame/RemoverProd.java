...
public class RemoverProd extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Remover Produto");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemoverProd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RemoverProd().setVisible(true);
            }
        });
    }
