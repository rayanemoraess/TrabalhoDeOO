 ...
 * @author pedro
 */
public class ModificandoID extends javax.swing.JFrame {

    /**
     * Creates new form ModificandoID
     */
    public ModificandoID() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Modificando ID do Produto");

        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
        jLabel5.setText("ID Atual:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificandoID.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificandoID().setVisible(true);
            }
        });
    }
